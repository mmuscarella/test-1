...
p2 <- p + scale_shape_manual(values = c(15, 16, 17, 18)) + geom_point(position=pd, size=5)  + scale_colour_manual(values = c("#999999", "#CCFF00", "#009933", "#003300")) + xlab("Moisture (%)") + geom_errorbar(aes(ymin=DEA-se, ymax=DEA+se), colour="black", width=7, position=pd) + ylab("Denitrification Rate\n(ng N2O * g^-1 sediment * hr^-1)") + scale_x_continuous(breaks=seq(0, 70, 10)) + theme(legend.justification=c(0,-1), legend.position=c(0.075,0)) + 
